...
#2 단계 - RL 적용
#1 RL 은 머신러닝 중에서도 순서가 있는 액션을 취하는 것과 관련된 분야입니다.
...
#3 두 개의 완전연결층(Fully Connected Layer)을 구축합니다.
#https://karpathy.github.io/assets/rl/policy.png
#이미지 픽셀을 받아서, 위쪽 이동의 확률을 출력합니다 (확률론적, stochasticity).

#3 단계 - Policy Gradients는 지도 학습과 3 가지의 주된 차이점이 있습니다.
#1 정답 레이블된 데이타가 없기 때문에, 일종의 가짜 레이블로써 Policy에서 샘플링한 액션을 대신 사용합니다.
